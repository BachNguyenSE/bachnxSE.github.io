...
class ViewDetailAccessoryToBought extends StatefulWidget {
  ...
  final int userID;
  const ViewDetailAccessoryToBought(
      {Key? key,
  ...
  @override
  _ViewDetailAccessoryToBoughtState createState() =>
      _ViewDetailAccessoryToBoughtState(responseId, carID, userID);
}

class _ViewDetailAccessoryToBoughtState
    extends State<ViewDetailAccessoryToBought> {
  final String responseId, carID;
  final int userID;
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    BrandNameScreen(id: data.exchangeAccessorryDetails[0].brandId)
