...
class ViewAccessoryDetailToSell extends StatefulWidget {
  ...
  const ViewAccessoryDetailToSell({Key? key, required this.accessoryId})
      : super(key: key);

  @override
  _ViewAccessoryDetailToSellState createState() =>
      _ViewAccessoryDetailToSellState(accessoryId);
}
