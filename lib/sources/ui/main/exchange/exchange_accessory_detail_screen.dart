...
class ExchangeAccessoryDetailScreen extends StatefulWidget {
  final String id;
  const ExchangeAccessoryDetailScreen({Key? key, required this.id})
      : super(key: key);

  @override
  _ExchangeAccessoryDetailScreenState createState() =>
      _ExchangeAccessoryDetailScreenState(id);
}

class _ExchangeAccessoryDetailScreenState
    extends State<ExchangeAccessoryDetailScreen> {
  final String id;
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    BrandNameScreen(
                        id: data.exchangeAccessorryDetails[0].brandId)
                  ],
                ),
                SizedBox(
                  height: 1.h,
                ...
                Row(
                  children: [
                    ...
                    Text(
                      data.exchangeAccessorryDetails[0].amount.toString() +
                          " cái",
                      style:
                          TextStyle(fontSize: 16, fontWeight: FontWeight.bold),
                    ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    TextFormField(
                                      ...
                                      validator: (value) {
                                        if (value!.isEmpty) {
                                          return 'Vui lòng nhập thông điệp';
                                        }
                                        return null;
                                      },
                                    ),
                                    ...
                                    if (result == true) {
                                      showDialog(
                                        ...
                                        builder: (BuildContext context) {
                                          return AlertDialog(
                                            ...
                                            content: new Text("Liên hệ thành công"),
                                            actions: <Widget>[
                                              new FlatButton(
                                                child: new Text("Đóng"),
                                                onPressed: () {
                                      ...
                                      showDialog(
                                        ...
                                        builder: (BuildContext context) {
                                          return AlertDialog(
                                            title: new Text("Thông báo!"),
                                            content: new Text("Liên hệ thất bại"),
                                            actions: <Widget>[
                                              new FlatButton(
                                                child: new Text("Đóng"),
                                                onPressed: () {
