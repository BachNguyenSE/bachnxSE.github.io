...
import 'package:car_world_system/sources/ui/login/started_using_page.dart';
...
class ChooseInterestBrand extends StatefulWidget {
  // ignore: use_key_in_widget_constructors
  ChooseInterestBrand();
  @override
  _ChooseInterestBrandState createState() => _ChooseInterestBrandState();
}

class _ChooseInterestBrandState extends State<ChooseInterestBrand> {
  // bool isInit = true;
  ...
  Future<void> getListBrand() async {
    ...
    setState(() {
      ...
      //_foundedUsers = userData; // t nhớ r, do nếu t xài cái _userData này không á, thì list bên dưới bị rỗng đúng không
    });
    getList(_brandData);
  }
